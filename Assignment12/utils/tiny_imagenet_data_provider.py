...
import numpy as np
from utils import tiny_imagenet_v2
...
def get_train_test_data(path):
  g_classes, g_class_to_idx = tiny_imagenet_v2.find_classes(path)
  train_file_names = []
  test_file_names = []
  ...
  train_file_names, test_file_names, train_classname_dict, test_classname_dict, classes_dict = tiny_imagenet_v2.split_data(path,g_class_to_idx)
  
  train = tiny_imagenet_v2.TinyImagenet200(path,train_file_names, train_classname_dict,classes_dict,transform = Alb_Transform_Train())
  test = tiny_imagenet_v2.TinyImagenet200(path,test_file_names,test_classname_dict,classes_dict,Alb_Transform_Test())
  return train, test
